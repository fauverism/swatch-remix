...
function woo_custom_navigation() {
	...
	<div id="no-js"><h3>You do not have JavaScript enabled in your browser. Please enabled it to access the Custom Menu functionality.</h3></div>
		...
		<div id="pages-left">
			...
			<form onsubmit="updatepostdata()" action="" method="post"  enctype="multipart/form-data">
				...
				<div class="widget-holder">
					...
					<select id="menu_select" name="menu_select">
						...
						foreach ($custom_menu_records as $custom_menu_record)
						{
							...
							?>
							<option value="<?php echo esc_attr( $custom_menu_record->id ); ?>" <?php echo $selected_option; ?>><?php echo $custom_menu_record->menu_name; ?></option>
							<?php
...
function woo_custom_navigation_output($args = array()) {
		...
		if (isset($args)) {
			...
			extract($args);
			$anchor_title = ( isset( $anchor_title ) ) ? $anchor_title : '';
		}
		...
		foreach ($woo_custom_nav_menu as $woo_custom_nav_menu_items) {
			...
			?><?php
					...
					if ($type == "frontend")
					{
						?><li <?php echo $li_class; ?>><a title="<?php echo esc_attr( $anchor_title ); ?>" href="<?php echo $link; ?>" <?php echo $target; ?>><?php echo stripslashes($before_title).esc_html( $title ).stripslashes($after_title); ?><?php
	...
	else
	{
		...
		foreach ($woo_custom_nav_menu as $sub_item)
		{
			...
			?><?php
						...
						{
							?>
							<li id="menu-<?php echo esc_attr( $counter ); ?>" value="<?php echo esc_attr( $counter ); ?>" <?php echo $li_class; ?>>
							<dl>
							<dt>
							...
							<input type="hidden" name="dbid<?php echo esc_attr( $counter ); ?>" id="dbid<?php echo esc_attr( $counter ); ?>" value="<?php echo esc_attr( $sub_item->id ); ?>" />
							<input type="hidden" name="postmenu<?php echo esc_attr( $counter ); ?>" id="postmenu<?php echo esc_attr( $counter ); ?>" value="<?php echo esc_attr( $post_id ); ?>" />
							<input type="hidden" name="parent<?php echo esc_attr( $counter ); ?>" id="parent<?php echo esc_attr( $counter ); ?>" value="<?php echo esc_attr( $parent_id ); ?>" />
							<input type="hidden" name="title<?php echo esc_attr( $counter ); ?>" id="title<?php echo esc_attr( $counter ); ?>" value="<?php echo esc_attr( $title ); ?>" />
							<input type="hidden" name="linkurl<?php echo esc_attr( $counter ); ?>" id="linkurl<?php echo esc_attr( $counter ); ?>" value="<?php echo esc_attr( $link ); ?>" />
							<input type="hidden" name="description<?php echo esc_attr( $counter ); ?>" id="description<?php echo esc_attr( $counter ); ?>" value="<?php echo esc_attr( $description ); ?>" />
							<input type="hidden" name="icon<?php echo esc_attr( $counter ); ?>" id="icon<?php echo esc_attr( $counter ); ?>" value="0" />
							<input type="hidden" name="position<?php echo esc_attr( $counter ); ?>" id="position<?php echo esc_attr( $counter ); ?>" value="<?php echo esc_attr( $counter ); ?>" />
							<input type="hidden" name="linktype<?php echo esc_attr( $counter ); ?>" id="linktype<?php echo esc_attr( $counter ); ?>" value="<?php echo esc_attr( $sub_item->link_type ); ?>" />
							<input type="hidden" name="anchortitle<?php echo esc_attr( $counter ); ?>" id="anchortitle<?php echo esc_attr( $counter ); ?>" value="<?php echo esc_attr( $anchor_title ); ?>" />
							<input type="hidden" name="newwindow<?php echo esc_attr( $counter ); ?>" id="newwindow<?php echo esc_attr( $counter ); ?>" value="<?php echo esc_attr( $sub_item->new_window ); ?>" />
							<?php
						}
		...
		foreach ($pages_array as $post)
		{
			...
			if ($post->post_parent == 0)
			{
				...
				if ($type == 'menu')
				{
					...
					<li id="menu-<?php echo esc_attr( $intCounter ); ?>" value="<?php echo esc_attr( $intCounter ); ?>">
...
function woo_custom_navigation_default_sub_items($childof, $intCounter, $parentli, $type, $output_type) {
	...
	if ($sub_array)
	{
		...
		foreach ($sub_array as $sub_item)
		{
			...
			{
				?>
				<li id="menu-<?php echo esc_attr( $counter ); ?>" value="<?php echo esc_attr( $counter ); ?>">
					<dl>
					<dt>
						<span class="title"><?php echo $title; ?></span>
							<span class="controls">
					...
					<a class="hide" href="<?php echo $link; ?>"><?php echo $title; ?></a>
					<input type="hidden" name="dbid<?php echo esc_attr( $counter ); ?>" id="dbid<?php echo esc_attr( $counter ); ?>" value="<?php echo $sub_item->id; ?>" />
					<input type="hidden" name="postmenu<?php echo esc_attr( $counter ); ?>" id="postmenu<?php echo esc_attr( $counter ); ?>" value="<?php echo $parent_id; ?>" />
					<input type="hidden" name="parent<?php echo esc_attr( $counter ); ?>" id="parent<?php echo esc_attr( $counter ); ?>" value="<?php echo $parentli; ?>" />
					<input type="hidden" name="title<?php echo esc_attr( $counter ); ?>" id="title<?php echo esc_attr( $counter ); ?>" value="<?php echo $title; ?>" />
					<input type="hidden" name="linkurl<?php echo esc_attr( $counter ); ?>" id="linkurl<?php echo esc_attr( $counter ); ?>" value="<?php echo $link; ?>" />
					<input type="hidden" name="description<?php echo esc_attr( $counter ); ?>" id="description<?php echo esc_attr( $counter ); ?>" value="<?php echo $description; ?>" />
					<input type="hidden" name="icon<?php echo esc_attr( $counter ); ?>" id="icon<?php echo esc_attr( $counter ); ?>" value="0" />
					<input type="hidden" name="position<?php echo esc_attr( $counter ); ?>" id="position<?php echo esc_attr( $counter ); ?>" value="<?php echo esc_attr( $counter ); ?>" />
					<input type="hidden" name="linktype<?php echo esc_attr( $counter ); ?>" id="linktype<?php echo esc_attr( $counter ); ?>" value="<?php echo $linktype; ?>" />
					<input type="hidden" name="anchortitle<?php echo esc_attr( $counter ); ?>" id="anchortitle<?php echo esc_attr( $counter ); ?>" value="<?php echo $title; ?>" />
					<input type="hidden" name="newwindow<?php echo esc_attr( $counter ); ?>" id="newwindow<?php echo esc_attr( $counter ); ?>" value="0" />
