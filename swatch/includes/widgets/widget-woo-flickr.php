...
class Woo_flickr extends WP_Widget {
	...
	function widget( $args, $instance ) {
        ...
        <div class="wrap">
            <div class="fix"></div>
            <script type="text/javascript" src="<?php echo esc_url( 'http://www.flickr.com/badge_code_v2.gne?count=' . $number . '&amp;display=' . $sorting . '&amp;layout=x&amp;source=' . $type . '&amp;' . $type . '=' . $id . '&amp;size=' . $size ); ?>"></script>
            <div class="fix"></div>
        </div><?php
	   echo $after_widget;
   }
